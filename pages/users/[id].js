import {AddressContainer, CommonInfo, Container, Name, Photo} from "../../styles/User.styles";
        ...
        <Layout>
            <Container>
                ...
                <CommonInfo>
                    ...
                    <p>Site: <a href={user.website} target="_blank">{user.website}</a></p>
...
export const getStaticPaths = async () => {
    const paths = await API.getPaths('users')
